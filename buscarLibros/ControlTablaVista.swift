...
//clase que permite almacenar informacion del libro
struct Libro {
...
class ControlTablaVista: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Ultimos libros Consultados"
